    ...
    private void b1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b1ActionPerformed
       ...
       if(buttonused[0] == 0) {
        ...
        if(turn%2 == 0) {
            ...
            if(result1 == 1) {
                JOptionPane.showMessageDialog(rootPane, "Player 1 has won the game!" );
            } else if(result2 == 1) {
                JOptionPane.showMessageDialog(rootPane, "Player 2 has won the game!" );
            }
           ...
           JOptionPane.showMessageDialog(rootPane, "This button has been used!" );
       }
